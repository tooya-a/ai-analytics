...
> **チームメンバー一人ひとりのAI活用スキルを可視化・フィードバックし、個人とチーム全体の「AIとの協働能力」を継続的に高める。**

このアプリが計測しているのは「チームメンバーがAIをどう使っているか」という行動データ。

| フィールド | 意味 |
|---|---|
| `pivot_count` | 何回方針を変えたか（試行錯誤の量） |
| `resolution` | 最終的に解決できたか |
| `category` + `approach` | どんな問題にどう立ち向かったか |
| `blockers` | 何に詰まったか |

タブ3ではこれらのデータをClaudeが分析し、思考パターンの癖や改善できる点を提示する。

つまりこのアプリの本質は **「AIの使い方そのものを改善するための、メタツール」**。

- 単なる「使いました記録」ではなく、どう使えば成果が出るかを学習するための仕組み
- 個人の振り返りツールであり、チームの知識共有プラットフォーム
- 最終的には「このチームはAIをうまく使える」という状態を組織として達成する
